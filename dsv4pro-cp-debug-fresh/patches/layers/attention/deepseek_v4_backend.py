        ...
        if isinstance(core_attn_metadata, DSV4AttnMetadata):
            ...
            _cp_debug_dump(
                ...
                extra={
                    ...
                    "swa_page_indices_shape0": core_attn_metadata.swa_page_indices.shape[
                        0
                    ],
                    "swa_topk_lengths_shape0": core_attn_metadata.swa_topk_lengths.shape[
                        0
                    ],
                },
            )
            ...
            _cp_debug_dump(
                "P3_post_match_extra_indices",
                extra_indices,
                layer_id=layer_id,
                extra={"compress_ratio": compress_ratio, "q_shape0": q.shape[0]},
            )
            _cp_debug_dump(
                "P3_post_match_extra_topk_lengths",
                extra_topk_lengths,
                layer_id=layer_id,
                extra={"compress_ratio": compress_ratio, "q_shape0": q.shape[0]},
            )
