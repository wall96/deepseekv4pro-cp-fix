...
# Temporary CP/PP precision debugging instrumentation; see
# python/sglang/srt/utils/cp_pp_debug.py. Delete once the DeepSeek-V4-Pro
# prefill-CP (round-robin-split) precision-loss root cause is found and fixed.
from sglang.srt.utils.cp_pp_debug import cp_debug_dump_dict as _cp_debug_dump_dict
...
class SchedulerPPMixin:
    ...
    def _pp_recv_proxy_tensors(self: Scheduler) -> Optional[PPProxyTensors]:
        ...
        if not self.pp_group.is_first_rank:
            ...
            _cp_debug_dump_dict("PP_RECV", pp_proxy_tensors.tensors)
