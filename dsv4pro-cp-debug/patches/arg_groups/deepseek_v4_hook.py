...
def validate_deepseek_v4_cp(server_args: ServerArgs) -> None:
    ...
    if envs.SGLANG_TEST_CP_KEEP_SPARSE_PREFILL.get():
        logger.warning(
            "SGLANG_TEST_CP_KEEP_SPARSE_PREFILL=1: leaving "
            "SGLANG_OPT_FLASHMLA_SPARSE_PREFILL enabled under DeepSeekV4 context "
            "parallelism (investigation-only override, see dsv4pro/log-analysis.md "
            "section 19)."
        )
    else:
        logger.warning(
