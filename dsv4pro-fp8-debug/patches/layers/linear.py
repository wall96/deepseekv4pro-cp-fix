...
class LinearBase(torch.nn.Module):
    ...
    def __init__(
        ...
        # [FP8_DEBUG] stash prefix on every LinearBase instance so weight_loader_v2
        # can report which layer failed to load; not set unconditionally upstream.
        self.prefix = prefix
...
class ColumnParallelLinear(LinearBase):
    ...
    def weight_loader_v2(self, param: Parameter, loaded_weight: torch.Tensor):
        ...
        try:
            ...
            e.add_note(
                f"[FP8_DEBUG] ColumnParallelLinear.weight_loader_v2 failed: "
                f"prefix={self.prefix!r} param_type={type(param).__name__} "
                f"param_dtype={param.dtype} loaded_weight_dtype={loaded_weight.dtype} "
...
class MergedColumnParallelLinear(ColumnParallelLinear):
    ...
    def weight_loader_v2(
        ...
        try:
            ...
            e.add_note(
                f"[FP8_DEBUG] MergedColumnParallelLinear.weight_loader_v2 failed: "
                f"prefix={self.prefix!r} loaded_shard_id={loaded_shard_id!r} "
                f"param_type={type(param).__name__} param_dtype={param.dtype} "
                f"loaded_weight_dtype={loaded_weight.dtype} param_shape={tuple(param.shape)} "
                f"loaded_weight_shape={tuple(loaded_weight.shape)}"
            )
            raise
...
class QKVParallelLinear(ColumnParallelLinear):
    ...
    def weight_loader_v2(
        ...
        try:
            ...
            e.add_note(
                f"[FP8_DEBUG] QKVParallelLinear.weight_loader_v2 failed: "
                f"prefix={self.prefix!r} loaded_shard_id={loaded_shard_id!r} "
                f"param_type={type(param).__name__} param_dtype={param.dtype} "
                f"loaded_weight_dtype={loaded_weight.dtype} param_shape={tuple(param.shape)} "
                f"loaded_weight_shape={tuple(loaded_weight.shape)}"
...
class RowParallelLinear(LinearBase):
    ...
    def weight_loader_v2(self, param: BasevLLMParameter, loaded_weight: torch.Tensor):
        ...
        try:
            ...
            e.add_note(
                f"[FP8_DEBUG] RowParallelLinear.weight_loader_v2 failed: "
                f"prefix={self.prefix!r} param_type={type(param).__name__} "
                f"param_dtype={param.dtype} loaded_weight_dtype={loaded_weight.dtype} "
                f"param_shape={tuple(param.shape)} "
                f"loaded_weight_shape={tuple(loaded_weight.shape)}"
